            ...
            try:
                ...
                if os.path.exists(tunnel_script):
                    try:
                        ...
                        await message.channel.send("⚠️ Failed to start tunnel script")

                # Start pr-live.py as a subprocess
                self.webpanel_process = subprocess.Popen(
                    [sys.executable, "pr-live.py"],
            ...
            try:
                ...
                if self.tunnel_process:
                    try:
                        ...
                        # Also try taskkill for the batch file / cloudflared
                ...
                await message.channel.send("Web panel was **force stopped ❌**")
            except ProcessOperationError as e:
