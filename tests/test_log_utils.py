...
from patchraptor.log_utils import extract_server_info_from_log, get_logs_directory, find_matching_log_file
...
class TestLogUtils:
    ...
    def test_find_log_file_sort(self):
        ...
        with patch("os.listdir", return_value=files), \
             ...
             patch("patchraptor.log_utils.extract_server_info_from_log", side_effect=mock_extract):
